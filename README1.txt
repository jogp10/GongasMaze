...
store their positions in y and x axis and so we knew whether they were alive or not.
...
stumble upon some bugs but also found some "bad practises" we were committing, such as not using a header file. Most of the bugs we
